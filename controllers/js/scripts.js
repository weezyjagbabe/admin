var App = function () {
    ...
    var handleChat = function () {
        ...
        var handleClick = function () {
            ...
            var tpl = '';
            tpl += '<li class="out">';
            tpl += '<img class="avatar" alt="" src="../../models/img/avatar1.jpg"/>';
    ...
    var handleLoginForm = function () {
        ...
        jQuery('#return-in').click(function () {
    ...
    var handleGritterNotifications = function () {
        ...
        $('#gritter-sticky').click(function () {
            var unique_id = $.gritter.add({
                ...
                image: '../../models/img/avatar-mini.png',
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../models/img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
