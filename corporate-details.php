...
$pageName = "Corporate Details"; 																// Set the page name
...
//                                print_r($admin);
                                ...
                                <div class="span9">
                                    <h4><?php echo $admin['fullName']; ?><br><small><?php echo $admin['designation']; ?></small></h4>
                                    <table class="table table-borderless">
                                        <tbody>
<!--                                        <tr><td class="span2">First Name :</td><td> --><?php //echo $admin['firstName']; ?><!-- </td></tr>-->
                                        <tr><td class="span2">Name :</td><td> <?php echo $admin['fullName']; ?> </td></tr>
                                        <tr><td class="span2">Department :</td><td> <?php echo $admin['department']; ?> </td></tr>
...
<!--                                        <tr><td class="span2">Position :</td><td> --><?php //echo $admin['adminPosition']; ?><!-- </td></tr>-->
                                        <tr><td class="span2">Email :</td><td> <?php echo $admin['email']; ?> </td></tr>
                                        <tr><td class="span2">Phone :</td><td> <?php echo $admin['officePhone']; ?> </td></tr>
                                        <tr><td class="span2">Mobile :</td><td> <?php echo $admin['mobilePhone']; ?> </td></tr>
                                        <tr><td class="span2">Provider Key :</td><td> <?php echo $admin['providerKey']; ?> </td></tr>
                                        </tbody>
                                    </table>
...
<!--                                            <strong>--><?php //echo $admin['adminResAddress']; ?><!--</strong><br>-->
                                            <abbr title="Phone">P:</abbr> <?php echo $admin['officePhone']; ?>
                                        </address>

                                        <address>
                                            <strong>Email</strong><br>
                                            <a href="mailto:#"><?php echo $admin['email']; ?></a>
                                        </address>
                                    </div>
                                </div>
