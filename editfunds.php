...
$pageName = 'Edit Funds'; 																			// Set the page name
                    ...
                    <div class="widget-body">
                        ...
                        <div class="span9">
                            <div style="margin-bottom: 25px">
                                ...
                                $Database -> where('paymentSourceKey',$t);
                                $info = $Database -> get('tlr_payment_sources',null,'*');
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="input-icon left">
                                                <i class="icon-home"></i>
                                                <input type="text" class="span12" name="sourceName" placeholder="Payment Source Name" value="<?php echo $stuff['paymentSourceName']?>" required/>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="fileupload fileupload-new span12" data-provides="fileupload">
                                                ...
                                                <div class="input-append">
                                                    <div class="uneditable-input" style="width: 625px;">
                                                        ...
                                                        <?php echo $stuff['paymentSourceLogo']?>
...
<!--																<span class="fileupload-new">Select Logo</span>-->
                                        ...
                                        <div class="controls">
                                            <select class="span12" name="categoryID" data-placeholder="Choose a Category" tabindex="1" required>
                                                ...
                                                if( $Database -> count > 0 )
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $category['paymentSourceCatID'].$category['paymentSourceCatKey']; ?>"<?php if($category['paymentSourceCatID'].$category['paymentSourceCatKey'] == $stuff['paymentSourceCatID'].$stuff['paymentSourceCatKey']) {?> selected <?php } ?>>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <textarea class="span12" name="sourceDesc" rows="4"><?php echo $stuff['paymentSourceDesc']?></textarea>
                                        </div>
                                    </div>

                                    <input type="hidden" name="sourceKey" value="<?php echo $t; ?>" />

                                    <!-- Begin submit button -->
                                    <button type="submit" name="UpdateSource" class="btn btn-success" style="width: 230px;">Update Payment Source</button>
