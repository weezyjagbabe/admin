			...
			if ( $templateName == "Account Verification" ) 
			{
				...
				{$header}
						<div style='margin: 0 auto; padding: 0 40px;'>
							...
							<p>Welcome to the <a href='".LINK."'>".PRODUCTNAME."</a> The number one leading online payment system! For security reasons, please verify your email to complete your registration.</p><br />
							
							<p>To verify, please click the button below.</p>
							<a href='".LINK."/admin/activation-{$userEmail}-{$code}'><button class='button'>Activate your account now</button></a>
							
							<br /><div class='line'></div><br />
							
							<p>Or copy and paste the link below in to your web browser:</p>
							<p><a href='".LINK."/admin/activation-{$userEmail}-{$code}'>href='".LINK."activation-{$userEmail}-{$code}'</a></p>
			...
			else if ( $templateName == "Reset Password" ) 
			{
				...
				{$header}
						<div style='margin: 0 auto; padding: 0 40px;'>
							...
							<p>If you did not request a password reset, please ignore this email or reply to let us know. This password link is only valid for the next 30 minutes.</p>
