<?php
	...
	$pageName = "Previous Accounts"; 														// Set the page name
			...
			<div id="main-content">
				<div class="container-fluid">
					...
					<div id="page" class="dashboard">
								...
								<div class="widget">
									...
									<div class="widget-body invoice">
										<?php 
											...
											$transactedAmounts = $Database -> get( "tlr_totalTransactedAmount_view" );
								...
								<div class="widget">
									...
									<div class="widget-body invoice">
										<?php 
											...
											$trasactionCharges = $Database -> get( "tlr_totalCommissionAmount_view" );
								...
								<div class="widget">
									...
									<div class="widget-body invoice">
										<?php 
											...
											$billingAmounts = $Database -> get( "tlr_totalbillingAmount_view" );
						...
						<?php
							require_once './views/pageTotalAccounts.php'; // Include the daily accounts
						?>
